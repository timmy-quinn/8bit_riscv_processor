...
#
# Generated by export_simulation on Fri Dec 02 16:05:13 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './inst_mem.sh' script.

./inst_mem.sh -reset_run
...
./inst_mem.sh -noclean_files

For more information on the script, please type './inst_mem.sh -help'.
