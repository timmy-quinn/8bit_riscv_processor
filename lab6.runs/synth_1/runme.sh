...
HD_PWD='C:/Users/quinn.ti.NUNET/Documents/lab6/lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_instrmem_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_instrmem_top.tcl
