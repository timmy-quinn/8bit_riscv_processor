...
HD_PWD='C:/Users/quinn.ti.NUNET/Documents/lab6/lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_instrmem_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_instrmem_top.tcl -notrace
